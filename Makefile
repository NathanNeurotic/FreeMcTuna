...
EE_OBJS += OpenTuna_sys.o OpenTuna_SLIMS.o OpenTuna_FAT-170.o OpenTuna_FAT-110-120-150-160.o \
	...
	APPS_ICON_SYS.o \
	APPS_LIST_ICN.o \
	APP_ESR-LAUNCHER_COPY_ICN.o \
	APP_ESR-LAUNCHER_DEL_ICN.o \
	APP_ESR-LAUNCHER_ESR-LAUNCHER_ELF.o \
	APP_ESR-LAUNCHER_ICON_SYS.o \
	APP_ESR-LAUNCHER_LIST_ICN.o \
	APP_ESR-LAUNCHER_TITLE_CFG.o \
	...
	NEUTRINO_CONFIG_PCSX2-HDL_TOML.o \
	NEUTRINO_CONFIG_PCSX2_TOML.o \
	NEUTRINO_CONFIG_RC-UYA_TOML.o \
...
EE_SRC = OpenTuna_sys.s OpenTuna_SLIMS.s OpenTuna_FAT-170.s OpenTuna_FAT-110-120-150-160.s \
	...
	APPS_ICON_SYS.s \
	APPS_LIST_ICN.s \
	APP_ESR-LAUNCHER_COPY_ICN.s \
	APP_ESR-LAUNCHER_DEL_ICN.s \
	APP_ESR-LAUNCHER_ESR-LAUNCHER_ELF.s \
	APP_ESR-LAUNCHER_ICON_SYS.s \
	APP_ESR-LAUNCHER_LIST_ICN.s \
	APP_ESR-LAUNCHER_TITLE_CFG.s \
	...
	NEUTRINO_CONFIG_PCSX2-HDL_TOML.s \
	NEUTRINO_CONFIG_PCSX2_TOML.s \
	NEUTRINO_CONFIG_RC-UYA_TOML.s \
...
APP_ESR-LAUNCHER_COPY_ICN.s:
	bin2s INSTALL/APP_ESR-LAUNCHER/COPY.ICN APP_ESR-LAUNCHER_COPY_ICN.s APP_ESR-LAUNCHER_COPY_ICN

APP_ESR-LAUNCHER_DEL_ICN.s:
	bin2s INSTALL/APP_ESR-LAUNCHER/DEL.ICN APP_ESR-LAUNCHER_DEL_ICN.s APP_ESR-LAUNCHER_DEL_ICN

APP_ESR-LAUNCHER_ESR-LAUNCHER_ELF.s:
	bin2s INSTALL/APP_ESR-LAUNCHER/ESR-LAUNCHER.ELF APP_ESR-LAUNCHER_ESR-LAUNCHER_ELF.s APP_ESR-LAUNCHER_ESR-LAUNCHER_ELF

APP_ESR-LAUNCHER_ICON_SYS.s:
	bin2s INSTALL/APP_ESR-LAUNCHER/ICON.SYS APP_ESR-LAUNCHER_ICON_SYS.s APP_ESR-LAUNCHER_ICON_SYS

APP_ESR-LAUNCHER_LIST_ICN.s:
	bin2s INSTALL/APP_ESR-LAUNCHER/LIST.ICN APP_ESR-LAUNCHER_LIST_ICN.s APP_ESR-LAUNCHER_LIST_ICN

APP_ESR-LAUNCHER_TITLE_CFG.s:
	bin2s INSTALL/APP_ESR-LAUNCHER/TITLE.CFG APP_ESR-LAUNCHER_TITLE_CFG.s APP_ESR-LAUNCHER_TITLE_CFG
...
NEUTRINO_CONFIG_PCSX2-HDL_TOML.s:
	bin2s INSTALL/NEUTRINO/CONFIG/PCSX2-HDL.TOML NEUTRINO_CONFIG_PCSX2-HDL_TOML.s NEUTRINO_CONFIG_PCSX2-HDL_TOML

NEUTRINO_CONFIG_PCSX2_TOML.s:
	bin2s INSTALL/NEUTRINO/CONFIG/PCSX2.TOML NEUTRINO_CONFIG_PCSX2_TOML.s NEUTRINO_CONFIG_PCSX2_TOML

NEUTRINO_CONFIG_RC-UYA_TOML.s:
	bin2s INSTALL/NEUTRINO/CONFIG/RC-UYA.TOML NEUTRINO_CONFIG_RC-UYA_TOML.s NEUTRINO_CONFIG_RC-UYA_TOML
